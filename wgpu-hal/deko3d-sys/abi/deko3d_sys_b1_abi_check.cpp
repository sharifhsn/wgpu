...
CHECK_FN(dkCmdBufBarrier, void (*)(DkCmdBuf, DkBarrier, uint32_t));
...
CHECK_FN(dkCmdBufCopyBuffer, void (*)(DkCmdBuf, DkGpuAddr, DkGpuAddr, uint32_t));
...
CHECK_FN(dkCmdBufCopyImage, void (*)(DkCmdBuf, DkImageView const*, DkImageRect const*, DkImageView const*, DkImageRect const*, uint32_t));
...
CHECK_FN(dkQueueFlush, void (*)(DkQueue));
